...
export function ConnectWhatsappPanel({
  ...
  if (!isAdmin) {
    return (
      <div className="panel enter flex flex-col items-center gap-3 p-10 text-center">
  ...
  return (
    <div className="panel enter flex flex-col items-center gap-4 p-10 text-center">
      <span className="grid h-14 w-14 place-items-center rounded-full bg-brand-50 text-brand-700">
        <IconMessage className="h-7 w-7" />
      </span>
      <div>
        <p className="text-lg font-black text-ink">Conectar WhatsApp</p>
        <p className="mt-1 max-w-sm text-sm font-medium text-ink-muted">
      ...
      {qrcode ? (
        <div className="flex flex-col items-center gap-3">
          ...
          <img
            ...
            className="h-64 w-64 rounded-lg border border-line bg-surface p-2"
          />
