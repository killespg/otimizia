      ...
      <div className="p-5">
            ...
            <button
              ...
              className={
                ...
                (activeKey === template.key
                  ...
                  : "border-line bg-surface text-ink-soft hover:border-brand-300 hover:bg-brand-50 hover:text-brand-800")
              }
            >
              {template.label}
            </button>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <button
            type="button"
            onClick={copyText}
            className="press inline-flex min-h-11 items-center gap-1.5 rounded-lg border border-line bg-surface px-4 py-2 text-sm font-black text-ink-soft hover:bg-surface-2 hover:text-ink"
          >
