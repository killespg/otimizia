...
function Logo({ compact = false }: { compact?: boolean }) {
  // A área autenticada é sempre escura (design-system.md): logo escura fixa.
  return (
    <Link
      href="/dashboard"
...
export default async function AppLayout({
  ...
  return (
    <AssistantChatProvider>
      <div
        className={`app-frame workspace-${preset.key} min-h-[100dvh] bg-[linear-gradient(135deg,#b518ff_0%,#5c22e8_43%,#0bbfe8_100%)] p-0 sm:p-6`}
      >
