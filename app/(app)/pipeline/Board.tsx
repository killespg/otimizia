...
export default function Board({
  ...
  return (
    <div
      aria-busy={boardBusy}
      className="flex snap-x snap-mandatory gap-4 overflow-x-auto pb-2 xl:grid xl:grid-cols-5 xl:overflow-visible"
    >
                ...
                stageDeals.map((deal) => (
                  <article
                    ...
                    className={
                      ...
                      (boardBusy ? "cursor-wait opacity-70" : "cursor-grab active:cursor-grabbing") +
                      " " +
