...
export function DeleteAccountForm({
  ...
  return (
    <form action={action} className="space-y-3">
      ...
      <PendingButton
        disabled={!confirmed}
        className="press inline-flex items-center gap-1.5 rounded-lg border border-danger-200 bg-danger-50 px-3.5 py-2 text-sm font-black text-danger-700 hover:bg-danger-100 disabled:cursor-not-allowed disabled:opacity-50"
