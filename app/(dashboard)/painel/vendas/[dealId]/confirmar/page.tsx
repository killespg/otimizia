...
export default async function ConfirmSellerSalePage({ params }: { params: Promise<{ dealId: string }> }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[1550px] space-y-5">
      <Link href="/painel/vendas" className="inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-white/52 hover:text-white"><ArrowLeft size={15} /> Voltar às vendas</Link>
      <SellerPageHeader title="Fechar venda" description="Revise o cliente, adicione os itens reais e só então autentique o fechamento. O pedido, o estoque e as garantias serão criados juntos." />
