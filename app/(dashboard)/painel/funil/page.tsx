...
export default async function PipelinePage() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1640px] space-y-5">
      ...
      <form id="new-deal" action={createDeal} className={usesFlatPipeline ? "scroll-mt-24 border-y border-white/[0.08] py-5" : "scroll-mt-24 border border-white/[0.09] bg-od-muted-surface p-5"}>
