...
export function ConnectWhatsappPanel({
  ...
  return (
    <div className={flat ? "flex flex-col items-center gap-4 border-y border-white/[0.08] py-8 text-center" : "flex flex-col items-center gap-4 border border-white/[0.09] bg-od-muted-surface p-10 text-center"}>
