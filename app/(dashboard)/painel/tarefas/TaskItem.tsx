...
export default function TaskItem({
  ...
  return (
    <li className="flex flex-col gap-2 py-3">
      ...
      {canReview && (
        <form action={reviewTaskCompletion} className="ml-1 grid gap-2 rounded-md border border-line bg-surface-2 p-3 sm:grid-cols-[minmax(0,1fr)_auto_auto] sm:items-end">
          <input type="hidden" name="task_id" value={task.id}/><input type="hidden" name="return_to" value={returnTo}/>
