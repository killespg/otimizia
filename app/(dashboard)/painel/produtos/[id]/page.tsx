    ...
    <div className="mx-auto w-full max-w-[1500px] space-y-5">
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
        <div className="min-w-0 space-y-5">
          ...
          <section className="border border-white/[0.09] bg-[#1e1d22]/90">
            <header className="flex items-center justify-between gap-3 border-b border-white/[0.08] px-4 py-4"><div><h2 className="text-sm font-semibold text-white">Variações</h2><p className="mt-1 text-xs text-white/42">Tamanhos, cores, modelos, voltagens ou outras opções do mesmo produto.</p></div><Boxes size={18} className="text-od-text-2" /></header>
