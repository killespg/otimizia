    ...
    <div className="mx-auto w-full max-w-[1500px] space-y-5">
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
        ...
        <aside className="space-y-4">
          ...
          <section className="rounded-[var(--radius-panel)] border border-white/[0.09] bg-[#1e1d22]/90 p-4"><h2 className="text-sm font-semibold text-white">Criação rápida</h2><p className="mt-2 text-xs leading-relaxed text-od-text-3">Se este produto ainda não existisse, ele poderia ser criado diretamente ao fechar uma venda. Depois, esta tela serviria para completar fotos, variações e estoque.</p><Link href="/painel/vendas" className="mt-3 inline-flex min-h-11 items-center gap-2 text-xs font-semibold text-od-text-2"><PackagePlus size={15} /> Ir para vendas</Link></section>
        </aside>
      </div>
    </div>
  );
