      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
        <div className="min-w-0 space-y-5">
          ...
          <section className="panel">
            ...
            <details className="group border-t border-white/[0.08] p-4 first:border-t-0">
          ...
          <section id="ajustar-estoque" className="scroll-mt-24 panel">
