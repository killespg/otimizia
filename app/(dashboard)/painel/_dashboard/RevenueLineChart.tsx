  ...
  return (
    ...
    >
      ...
      {displayed && hoverXPercent !== null && (
        <div
          className={
            `pointer-events-none absolute top-2 -translate-x-1/2 rounded-md border border-line ${dark ? "bg-od-bg" : "bg-white"} px-2.5 py-1.5 text-xs font-bold text-ink shadow-[0_10px_28px_-16px_rgba(15,23,42,0.55)] transition-[left,opacity,transform] duration-100 ease-out ` +
