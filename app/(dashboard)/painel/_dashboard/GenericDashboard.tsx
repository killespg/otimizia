      ...
      <header className="dashboard-header enter flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-start justify-between gap-3 max-w-2xl">
          ...
          <div className="flex shrink-0 items-center gap-2 sm:hidden">
            <Link
              href="/painel/tarefas"
              className="nav-item relative grid h-11 w-11 place-items-center rounded-control border border-od-border bg-od-surface text-od-text-2 hover:text-brand-700"
        ...
        <form
          ...
          className="flex h-11 w-full min-w-0 items-center gap-2 rounded-inner border border-od-border bg-od-surface px-3 text-sm sm:hidden"
        >
        ...
        <div className="hidden flex-col gap-3 sm:flex sm:flex-row sm:items-center">
          <form
            action="/painel/contatos"
            className="flex h-11 w-full min-w-0 items-center gap-2 rounded-inner border border-od-border bg-od-surface px-3 text-sm sm:w-[430px]"
          >
            <IconSearch className="h-5 w-5 shrink-0 text-od-text-3" />
            ...
            <button
              type="submit"
              className="min-h-11 self-stretch rounded-control bg-od-muted-surface px-3 text-xs font-bold text-od-text-3 hover:bg-brand-50 hover:text-brand-700 focus-visible:ring-2 focus-visible:ring-brand-600"
            >
              Buscar
            </button>
          </form>
        ...
        {tasks.map((task) => (
          ...
          >
            ...
            <form action={claimTask}>
              ...
              <PendingButton
                className="min-h-11 shrink-0 rounded-control bg-brand-700 px-3 text-xs font-black text-white hover:bg-brand-800"
  ...
  return (
    <section className="enter relative rounded-md border border-brand-200 bg-brand-50 p-5">
      <form action={dismissChecklist} className="absolute right-3 top-3">
        <PendingButton
          className="nav-item grid size-11 place-items-center rounded-control text-od-text-3 hover:bg-od-surface/60 hover:text-od-text"
