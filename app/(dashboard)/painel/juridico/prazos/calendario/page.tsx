      ...
      <header className="enter flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex gap-2">
          <Link
            ...
            className="nav-item inline-flex min-h-11 items-center justify-center rounded-md border border-line bg-od-surface px-4 text-sm font-black text-ink-soft hover:border-brand-300 hover:bg-brand-50 hover:text-brand-800 focus-visible:ring-2 focus-visible:ring-brand-600"
          >
            Ver lista
          </Link>
          <Link
            ...
            className="nav-item grid h-11 w-11 place-items-center rounded-md border border-line bg-od-surface hover:border-brand-300 hover:bg-brand-50"
          >
