    ...
    <div className="mx-auto w-full max-w-[1640px] space-y-5">
      ...
      <section className="overflow-hidden border border-white/[0.09] bg-[#1e1d22]">
        ...
        {visibleCases.length === 0 ? (
          ...
          <div>
            <div className="hidden grid-cols-[minmax(0,1.5fr)_8rem_9rem_10rem] gap-4 border-b border-white/[0.07] px-5 py-2 text-od-label text-white/35 sm:grid"><span>Caso</span><span>Situação</span><span>Responsável</span><span>Próximo prazo</span></div>
