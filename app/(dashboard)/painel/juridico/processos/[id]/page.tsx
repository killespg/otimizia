...
export default async function LegalCasePage(props: { params: Promise<{ id: string }> }) {
  ...
  return <div className="mx-auto w-full max-w-[1640px] space-y-5">
    <Link href="/painel/juridico/processos" className="inline-flex items-center gap-2 text-[11px] font-semibold text-od-text-2 hover:text-od-text"><IconArrowRight className="h-3.5 w-3.5 rotate-180"/>Voltar para processos</Link>
