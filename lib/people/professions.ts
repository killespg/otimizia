...
export const PROFESSION_PRESETS: Record<ProfessionType, ProfessionPreset> = {
  ...
  law_office: {
    ...
    pipelineLabel: "Possíveis Clientes",
    pipelineTitle: "Possíveis clientes",
    pipelineDescription: "Arraste cada possível cliente pela triagem, documentos, viabilidade e honorários até virar processo.",
    dealSingular: "atendimento",
    dealPlural: "atendimentos",
    dealFieldLabel: "Como chegou",
    ...
    contactsDescription: "Registre quem chegou ao escritório, origem, documentos pendentes e próximos retornos.",
    newContactTitle: "Novo possível cliente",
    firstSteps: ["Cadastre um possível cliente", "Abra a triagem", "Agende um retorno"],
    assistantContext: "A pessoa atua em escritório de advocacia. Use vocabulário jurídico-comercial: possível cliente, triagem, consulta, documentos, proposta de honorários, contrato, retorno ao cliente, casos, prazos internos, honorários a receber e baixa de pagamentos. Nunca diga lead ou prospect. Diferencie proposta em negociação de contas a receber do escritório.",
    expertiseArea: "direito e advocacia",
    stages: {
      novo: { label: "Triagem Inicial", empty: "Novos pedidos de atendimento entram aqui." },
      em_contato: { label: "Análise de Viabilidade", empty: "Nenhuma análise em aberto." },
      negociacao: { label: "Proposta / Honorários", empty: "Nenhuma proposta de honorários agora." },
      ganho: { label: "Convertido (Processo Ativo)", empty: "Processos ativos aparecem aqui." },
    ...
    dealFields: [
      ...
      { key: "resumo_caso", label: "Resumo do caso", type: "text", placeholder: "O que a pessoa relatou" },
