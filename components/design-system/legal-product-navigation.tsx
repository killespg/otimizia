      ...
      >
        <header className="border-b border-white/[0.06] p-3 pb-4">
          <div className={`flex h-7 items-center ${collapsed ? "justify-center" : "justify-between"}`}>
            ...
            {!collapsed ? <button type="button" onClick={toggle} aria-label="Recolher menu" className="grid size-7 place-items-center rounded-xl text-od-text-3 hover:bg-white/[0.06] hover:text-white"><ChevronLeft size={15} /></button> : null}
          </div>
