    ...
    <>
      ...
      >
        ...
        <footer className="border-t border-white/[0.06] p-2">
          <Link href="/painel/configuracoes" prefetch={true} className={`flex min-h-9 items-center rounded-xl text-sm text-white/58 hover:bg-white/[0.05] hover:text-white ${collapsed ? "justify-center" : "gap-2 px-2"}`}><Settings size={16}/>{!collapsed ? <span>Configurações</span> : null}</Link>
