  ...
  return (
    <header className="sticky top-0 z-40 flex min-h-14 items-center border-b border-white/[0.05] bg-[#151419] px-4 md:px-8">
      ...
      <div className="ml-auto flex items-center gap-0.5">
        ...
        <Link href="/painel/imoveis/visitas" aria-label="Ver visitas" className="relative grid size-11 place-items-center rounded-lg text-od-text-3 hover:bg-white/[0.05] hover:text-white">
        ...
        <Link href="/painel/imoveis" aria-label="Abrir carteira" className="hidden size-11 place-items-center rounded-lg text-od-text-3 hover:bg-white/[0.05] hover:text-white sm:grid"><Building2 size={16} /></Link>
