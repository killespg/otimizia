  ...
  return (
    <div className="lp-shell">
      ...
      <div
        ...
        className="landing-cinematic-stage landing-cinematic-panel-stage mx-auto mt-8 w-full max-w-5xl scroll-mt-0 overflow-hidden sm:mt-10 lg:mt-12 min-[1536px]:max-w-6xl"
      >
        {children}
      </div>
    </div>
