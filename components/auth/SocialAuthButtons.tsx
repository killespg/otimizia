  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={handleClick}
        disabled={loading}
        className="flex min-h-[52px] w-full items-center justify-center gap-2.5 rounded-control border border-od-border bg-od-muted-surface text-base font-semibold text-od-text transition-colors hover:border-od-border-hover hover:bg-od-surface-hover disabled:pointer-events-none disabled:opacity-50"
      >
        {loading ? (
