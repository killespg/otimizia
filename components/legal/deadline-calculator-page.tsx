...
export function DeadlineCalculatorWidget() {
  ...
  return <div className="grid gap-8 py-8 lg:grid-cols-[minmax(0,1fr)_420px]">
    <section>
      ...
      <button type="button" onClick={calculate} className="mt-7 inline-flex h-11 items-center gap-2 rounded-[var(--radius-control)] bg-od-accent px-4 text-xs font-semibold text-white hover:bg-od-accent-hover"><Calculator size={14} />Calcular prazo</button>
